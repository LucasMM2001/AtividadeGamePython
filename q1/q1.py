...
while True:
    ...
    # Definindo os limites para a cor vermelha (bola)
    ...
    # Detectando os contornos da bola vermelha
    ...
    # Definindo os limites para a cor azul (barra)
    lower_blue = np.array([100, 150, 50])
    upper_blue = np.array([140, 255, 255])
    mask_blue = cv2.inRange(hsv, lower_blue, upper_blue)

    # Detectando os contornos da barra azul
    ...
    if red_rect and blue_rect:
        ...
        # Verificando se a bola passou pela barreira
        if rx + rw < bx:
